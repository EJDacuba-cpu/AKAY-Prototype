...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('patients', function (Blueprint $table) {
            ...
            if (!Schema::hasColumn('patients', 'philhealth_status')) {
                $table->string('philhealth_status')->nullable();
            }
        });

        $this->refreshPatientJsonFunction(includeProfileFields: true);
    }
    ...
    public function down(): void
    {
        Schema::table('patients', function (Blueprint $table) {
            if (Schema::hasColumn('patients', 'philhealth_status')) {
                $table->dropColumn('philhealth_status');
            }
        ...
        $this->refreshPatientJsonFunction(includeProfileFields: false);
    }

    private function refreshPatientJsonFunction(bool $includeProfileFields): void
    {
        if (DB::connection()->getDriverName() !== 'pgsql') {
            return;
        }

        $profileFields = $includeProfileFields
            ? <<<'SQL'
